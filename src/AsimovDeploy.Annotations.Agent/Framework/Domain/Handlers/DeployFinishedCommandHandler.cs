...
{
    public class DeployFinishedCommandHandler : ICommandExecutor
    {
        public bool Handles(AsimovCommand command)
        {
            return command is DeployFinishedCommand;
        }
        ...
        public IEvent Execute(AsimovCommand command)
        {
            ...
            var completedCommand = (DeployFinishedCommand)command;
            return new DeployFinishedEvent
                   {
                       CorrelationId = completedCommand.correlationId,
                       Finished = completedCommand.timestamp,
